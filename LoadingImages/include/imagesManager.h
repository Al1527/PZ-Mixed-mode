...
public:
  ...
  cv::Mat getImagesByIndex(int index);
  void loadImages(std::filesystem::path directoryPath);
  ...
  cv::Mat removeAllOtherColors(cv::Mat img, cv::Scalar rgb, int lowerHueTolerance, int lowerSaturationTolerance, int lowerValueTolerance,
                            int upperHueTolerance, int upperSaturationTolerance, int upperValueTolerance);
